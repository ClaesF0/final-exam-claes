...
function EditAListing() {
  ...
  const handleUpdateListing = () => {
    ...
    dispatch(updateListing(id, updatedListingData)); // Dispatch the updateListing action with the id and updated data
  };
  ...
  //    <p>{listing.name}</p> {/* Render the listing data */}
...
//  const dispatch = useDispatch();
//
//  console.log("LISTING in EditAListing", listing);
//  console.log("LINE OK");
//
//  const TagInput = ({ placeholder, onTagsChange }) => {
//    const inputRef = useRef(null);
